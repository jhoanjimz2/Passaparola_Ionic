...
@Component({
  selector: 'app-bs-address-on-the-map',
  templateUrl: './bs-address-on-the-map.component.html',
  styleUrls: ['./bs-address-on-the-map.component.scss'],
})
export class BsAddressOnTheMapComponent implements OnInit {
