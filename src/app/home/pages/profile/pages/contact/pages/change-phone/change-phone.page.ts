...
@Component({
  selector: 'app-profile-change-phone',
...
export class ChangePhonePage implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.route.queryParams.subscribe((params: any) => {
      ...
      this.formContact.controls['idCountry'].setValue(this.user.country?.id);
      this.formContact.controls['phone'].setValue(this.user.phoneNumber!);
    });
  ...
  checkCode() {
    ...
    this.smsCodeService
      ...
      .pipe(
        switchMap(() => {
          const user: User = {
            ...
            countryID: this.formContact.controls['idCountry'].value,
          };
      ...
      .subscribe({
        next: (userResponse) => {
          this.user.phoneNumber = userResponse.phoneNumber;
          this.user.country = userResponse.country;
