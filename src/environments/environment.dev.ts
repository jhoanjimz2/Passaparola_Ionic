export const environment = {
  production: false,
  appName: 'Passaparola',
  apiKrathemis: 'http://192.168.1.34:3000/api',
  apiUnika: 'http://192.168.1.34:3001/api',
  ...
  urlBussinesRegister: 'http://localhost:4500',
  language: {
    default: 'es',
    list: ['es', 'it', 'en'],
  },
  ...
  wsUrl: 'http://localhost:3101/socket.io/socket.io.js',
